                ...
                <tr>
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            <tr>
                                 <td width="30%">
                                    <img src="../img/PeduliAnak.png" alt="" width="300%" background="none">
                                </td>
                            </tr>
                            <tr>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You sure want to delete this account permanently?<br>('.substr($nameget,0,40).').
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Enter a New Password" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
